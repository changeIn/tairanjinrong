					...
					<div style={{display: "block"}}>
						...
						<div className="container">
							...
							<div className="col-md-24 remind">
								<h4>温馨提示</h4>
								<ul>
									<li>1、为保障账户安全，泰然金融目前只支持绑定一张银行卡，以保证资金同卡进出，建议绑定常用的银行卡。</li>
									<li>2、由于央行规定非I类银行卡账户充值提现有金额限制，建议您绑定I类银行卡。</li>
									<li>3、实名认证需要年满18周岁以上。</li>
									<li>4、实名认证过程中充值的金额，在认证完成后，充值金额进入北京银行存管账户，账户余额可选择提现或者出借。</li>
									<li>5、所充值的资金如未出借，隔日才能申请提现。</li>
									<li>6、如遇到问题，请联系客服热线 0571-96056。</li>
								</ul>
							</div>
						</div>
					</div>
